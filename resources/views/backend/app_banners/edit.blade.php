    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" method="POST" action="{{ route('app-banner.update', $AppBanner) }}">
                        @csrf
                        @method('PATCH')
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">Name</label>
                            <div class="col-md-9">
                                <input type="text" placeholder="Name" value="{{ old('name', $AppBanner->name) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <input value="{{ old('banner', $AppBanner->image) }}" type="hidden" name="banner"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select onchange="banner_form()" class="form-control aiz-selectpicker" name="link_type"
                                    ...
                                    <option {{ old('link_type', $AppBanner->link_type) == 'external' ? 'selected' : '' }}
                                        value="external">
                                        External
                                    </option>
                                    <option {{ old('link_type', $AppBanner->link_type) == 'product' ? 'selected' : '' }}
                                        value="product">Product
                                    </option>
                                    <option {{ old('link_type', $AppBanner->link_type) == 'category' ? 'selected' : '' }}
                                        value="category">
                                        Category</option>
                                </select>
                                @error('link_type')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" placeholder="Sort Order"
                                    value="{{ old('sort_order', $AppBanner->sort_order) }}" id="sort_order"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control aiz-selectpicker" name="status" id="status" required>
                                    <option {{ old('status', $AppBanner->status) == '1' ? 'selected' : '' }}
                                        value="1">
                                        Enabled</option>
                                    <option {{ old('status', $AppBanner->status) == '0' ? 'selected' : '' }}
                                        value="0">
                                        Disabled</option>
                                </select>
                                @error('status')
...
@section('script')
    <script type="text/javascript">
        ...
        function banner_form() {
            ...
            var old_data = "{{ $AppBanner->link ?? $AppBanner->link_ref_id }}"
