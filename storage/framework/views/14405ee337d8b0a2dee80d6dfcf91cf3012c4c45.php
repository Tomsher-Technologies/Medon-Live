...
} elseif ($_instance->childHasBeenRendered('CBdcu5F')) {
    $componentId = $_instance->getRenderedChildComponentId('CBdcu5F');
    $componentTag = $_instance->getRenderedChildComponentTagName('CBdcu5F');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('CBdcu5F');
} else {
    $response = \Livewire\Livewire::mount('slug-check', ['model' => 'App\\Models\\Offers', 'template' => 2]);
    $html = $response->html();
    $_instance->logRenderedChild('CBdcu5F', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\jisha\Medon-Laravel\resources\views/backend/offers/create.blade.php ENDPATH**/ ?>