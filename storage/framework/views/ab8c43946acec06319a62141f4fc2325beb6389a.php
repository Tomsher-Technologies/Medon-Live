    ...
    <tbody>
        ...
        <?php $__currentLoopData = $combinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $combination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr class="variant">
                ...
                <td>
                    <input type="text" required name="sku_<?php echo e($str); ?>" value="<?php
                            if($stock != null) {
                                echo $stock->sku;
                            }
                            else {
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\jisha\Medon-Laravel\resources\views/backend/product/products/sku_combinations_edit.blade.php ENDPATH**/ ?>